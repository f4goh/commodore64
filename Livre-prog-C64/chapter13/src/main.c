...
WaveDefinition level1_waves[] = {
    ...
    {    344 , 0         , 1        , 0      , 110   , 2     , PATH_SINUSOID}, // 43
    {    440 , 2         , 1        , 0      , 90    , 2     , PATH_LINEAR},   // 55
    {    680 , 1         , 3        , 20     , 130   , 2     , PATH_LINEAR},   // 85
    {    744 , 1         , 3        , 20     , 90    , 2     , PATH_LINEAR},   // 93
    {    864 , 3         , 1        , 0      , 90    , 2     , PATH_LINEAR},   // 108
    {    984 , 4         , 1        , 0      , 90    , 2     , PATH_LINEAR},   // 123
    { 0xFFFF }
};
...
//    color       ,baseFrame,numFrames,animSpeed,hp  ,points,bbox_x,bbox_y,bbox_w,bbox_h,bulletTypeID,bulletPeriod,bulletAngle,powerUpTypeID
    ...
    { VCOL_BLUE   ,27       , 1       ,0        ,10  ,100   ,0     ,0     ,22    ,20    ,-1          ,0           ,0          ,PWR_SATELLITE},
    { VCOL_BLUE   ,27       , 1       ,0        ,10  ,100   ,0     ,0     ,22    ,20    ,-1          ,0           ,0          ,PWR_LASER},
    { VCOL_BLUE   ,27       , 1       ,0        ,10  ,100   ,0     ,0     ,22    ,20    ,-1          ,0           ,0          ,PWR_WAVE_FIRE},
};
