...
ancienne version gratuit
https://subchristsoftware.itch.io/charpad-c64-free

multipaint via processing java
...
copier les rom
ale@ale-desktop:/usr/share/vice/C64$ cp ~/commodore64/save/*.bin .

accéssible dans le menu


installation de oscar64
...
ale@ale-desktop:~/oscar64$ make -C make all

4. Vérifier l'exécutable

Cherche où le binaire a été généré :
...
# Oscar64 — Guide rapide (Linux Mint / Commodore 64)
...
## 🧩 Définir des macros (comme -D en gcc)
-dSYMBOL
-dSYMBOL=1
...
Test direct dans émulateur :
oscar64 main.c -O2 -e

Créer une disquette C64 :
